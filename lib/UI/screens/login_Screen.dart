...
import 'package:taskmanagement/Data/controller/login_provider.dart';
...
class _LoginScreenState extends State<LoginScreen> {
 final TextEditingController _EmailTEcontroller = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider( //direct aikane provider diye korlam
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Consumer<Loginprovider>( //ui e change dekte consumer diye korlam
                            builder: (context,loginprovider,_){
                              return Visibility(
                                visible: loginprovider.loginInprogresss == false,
 ...
 Future<void> _login() async {
    final bool isSucess = await _loginprovider.login(
